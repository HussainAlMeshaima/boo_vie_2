...
class BookVolume {
  ...
  factory BookVolume.fromMap(Map<String, dynamic> map) => BookVolume(
        kind: map['kind'] ?? '',
        id: map['id'] ?? '',
        eTag: map['etag'] ?? '',
  ...
  factory BookVolume.fromJson(String source) => BookVolume.fromMap(json.decode(source));

  @override
  String toString() {
    return 'BookVolume(kind: $kind, id: $id, eTag: $eTag, selfLink: $selfLink, volumeInfo: $volumeInfo, saleInfo: $saleInfo, accessInfo: $accessInfo)';
  }
...
class VolumeInfo {
  ...
  Map<String, dynamic> toMap() {
    ...
    return {
      ...
      'dimensions': newDimensions.toMap(),
      'printType': printType,
  ...
  factory VolumeInfo.fromMap(Map<String, dynamic> map) => VolumeInfo(
        ...
        dimensions:
            map['dimensions'] == null ? Dimensions() : Dimensions.fromMap(map['dimensions']),
  ...
  @override
  String toString() {
    return 'VolumeInfo(title: $title, publisher: $publisher, publishedDate: $publishedDate, readingModes: $readingModes, pageCount: $pageCount, printedPageCount: $printedPageCount, dimensions: $dimensions, printType: $printType, maturityRating: $maturityRating, allowAnonLogging: $allowAnonLogging, contentVersion: $contentVersion, panelizationSummary: $panelizationSummary, imageLinks: $imageLinks, language: $language, previewLink: $previewLink, infoLink: $infoLink, canonicalVolumeLink: $canonicalVolumeLink)';
  }
  ...
  bool operator ==(Object other) {
    ...
    return other is VolumeInfo &&
        ...
        other.printedPageCount == printedPageCount &&
...
class Dimensions {
  ...
  factory Dimensions.fromMap(Map<String, dynamic> map) => Dimensions(
        height: map['height'] ?? '',
      );
  ...
  @override
  String toString() => 'Dimensions(height: $height)';

  @override
  bool operator ==(Object other) {
    if (identical(this, other)) return true;

    return other is Dimensions && other.height == height;
  }
...
class ImageLinks {
  ...
  @override
  int get hashCode {
    return smallThumbnail.hashCode ^
        thumbnail.hashCode ^
        small.hashCode ^
        medium.hashCode ^
        large.hashCode ^
